...
function make_xlsx_lib(e) {
    ...
    function oe(e, r) {
        switch (typeof e) {
            ...
            case "object":
                if (e == null) return "";
                if (e instanceof Date) return ze(14, hr(e, r && r.date1904), r);
        }
    ...
    function de(e, r, t) {
        var a = r.replace(he, ""),
            n = r.length - a.length;
        return Me(e, a, t * Math.pow(10, 2 * n)) + yr("%", n)
    }
    ...
    function ge(e, r, t) {
        ...
        var s = n - i * a,
            l = a;
        return t + (i === 0 ? "" : "" + i) + " " + (s === 0 ? yr(" ", e[1].length + 1 + e[4].length) : W(s, e[1].length) + e[2] + "/" + e[3] + z(l, e[4].length))
    }
    ...
    function Te(e, r, t) {
        ...
        if (r.charCodeAt(0) === 36) return "$" + Te(e, r.substr(r.charAt(1) == " " ? 2 : 1), t);
        var n;
        ...
        if (r.match(/^[#?]+$/)) {
            n = G(t, 0);
            if (n === "0") n = "";
            return n.length > r.length ? n : xe(r.substr(0, r.length - n.length)) + n
        }
        if (i = r.match(ve)) return ge(i, o, c);
        if (r.match(/^#+0+$/)) return c + G(o, r.length - r.indexOf("0"));
        if (i = r.match(we)) {
            n = Se(t, i[1].length).replace(/^([^\.]+)$/, "$1." + xe(i[1])).replace(/\.$/, "." + xe(i[1])).replace(/\.(\d*)$/, function (e, r) {
                return "." + r + yr("0", xe(i[1]).length - r.length)
            });
        ...
        if (i = r.match(/^#{1,3},##0(\.?)$/)) return c + ue(G(o, 0));
        if (i = r.match(/^#,##0\.([#0]*0)$/)) {
            return t < 0 ? "-" + Te(e, r, -t) : ue("" + (Math.floor(t) + _e(t, i[1].length))) + "." + z(Ce(t, i[1].length), i[1].length)
        }
        if (i = r.match(/^#,#*,#0/)) return Te(e, r.replace(/^#,#*,/, ""), t);
        if (i = r.match(/^([0#]+)(\\?-([0#]+))+$/)) {
            n = U(Te(e, r.replace(/[\\-]/g, ""), t));
            s = 0;
            return U(U(r.replace(/\\/g, "")).replace(/[0#]/g, function (e) {
        ...
        if (i = r.match(/^([#0?]+)( ?)\/( ?)([#0?]+)/)) {
            ...
            n += f + i[2] + "/" + i[3];
            f = j(l[2], s);
            if (f.length < i[4].length) f = xe(i[4].substr(i[4].length - f.length)) + f;
            n += f;
            return n
        }
        if (i = r.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/)) {
            ...
            return c + (l[0] || (l[1] ? "" : "0")) + " " + (l[1] ? W(l[1], s) + i[2] + "/" + i[3] + j(l[2], s) : yr(" ", 2 * s + 1 + i[2].length + i[3].length))
        }
        if (i = r.match(/^[#0?]+$/)) {
            n = G(t, 0);
            if (r.length <= n.length) return n;
            return xe(r.substr(0, r.length - n.length)) + n
        }
        if (i = r.match(/^([#0?]+)\.([#0]+)$/)) {
            ...
            return xe(r.substr(0, u) + n + r.substr(r.length - h))
        }
        if (i = r.match(/^00,000\.([#0]*0)$/)) {
            s = Ce(t, i[1].length);
            return t < 0 ? "-" + Te(e, r, -t) : ue(Ae(t)).replace(/^\d,\d{3}$/, "0$&").replace(/^\d*$/, function (e) {
    ...
    function Oe(e, r, t) {
        ...
        if (r.charCodeAt(r.length - 1) === 44) return Ee(e, r, t);
        if (r.indexOf("%") !== -1) return Fe(e, r, t);
        if (r.indexOf("E") !== -1) return De(r, t);
        ...
        if (i = r.match(ve)) return be(i, o, c);
        if (r.match(/^#+0+$/)) return c + z(o, r.length - r.indexOf("0"));
        if (i = r.match(we)) {
            n = ("" + t).replace(/^([^\.]+)$/, "$1." + xe(i[1])).replace(/\.$/, "." + xe(i[1]));
        ...
        if (i = r.match(/^#,##0\.([#0]*0)$/)) {
            return t < 0 ? "-" + Oe(e, r, -t) : ue("" + t) + "." + yr("0", i[1].length)
        }
        if (i = r.match(/^#,#*,#0/)) return Oe(e, r.replace(/^#,#*,/, ""), t);
        if (i = r.match(/^([0#]+)(\\?-([0#]+))+$/)) {
            n = U(Oe(e, r.replace(/[\\-]/g, ""), t));
            s = 0;
            return U(U(r.replace(/\\/g, "")).replace(/[0#]/g, function (e) {
                return s < n.length ? n.charAt(s++) : e === "0" ? "0" : ""
            }))
        ...
        if (i = r.match(/^00,000\.([#0]*0)$/)) {
            return t < 0 ? "-" + Oe(e, r, -t) : ue("" + t).replace(/^\d,\d{3}$/, "0$&").replace(/^\d*$/, function (e) {
                return "00," + (e.length < 3 ? z(0, 3 - e.length) : "") + e
            }) + "." + z(0, i[1].length)
        }
        switch (r) {
            ...
            case "#,###":
                ...
                return d !== "0" ? c + d : "";
            default:
                if (r.match(/\.[0#?]*$/)) return Oe(e, r.slice(0, r.lastIndexOf(".")), t) + xe(r.slice(r.lastIndexOf(".")));
        }
        throw new Error("unsupported format |" + r + "|")
    }

    function Me(e, r, t) {
        return (t | 0) === t ? Oe(e, r, t) : Te(e, r, t)
    }
        ...
        while (s < e.length) {
            switch (l = e.charAt(s)) {
                ...
                case "$":
                    ...
                    break;
                default:
                    if (",$-+/():!^&'~{}<>=â‚¬acfijklopqrtuvwxzP".indexOf(l) === -1) throw new Error("unrecognized character " + l + " in " + e);
                    n[n.length] = {
                        t: "t",
                        v: l
                    };
        ...
        for (s = 0; s < n.length; ++s) {
            switch (n[s].t) {
                ...
                case "b":
                    ;
                case "Z":
                    n[s].v = fe(n[s].t.charCodeAt(0), n[s].v, c, g);
                    n[s].t = "t";
                    break;
                case "n":
                    ;
                case "?":
                    k = s + 1;
                    while (n[k] != null && ((l = n[k].t) === "?" || l === "D" || (l === " " || l === "t") && n[k + 1] != null && (n[k + 1].t === "?" || n[k + 1].t === "t" && n[k + 1].v === "/") || n[s].t === "(" && (l === " " || l === "n" || l === ")") || l === "t" && (n[k].v === "/" || n[k].v === " " && n[k + 1] != null && n[k + 1].t == "?"))) {
                        n[s].v += n[k].v;
                        n[k] = {
                            v: "",
                            t: ";"
        ...
        if (w.length > 0) {
            ...
            if (C === n.length && S.indexOf("E") === -1) {
                for (s = n.length - 1; s >= 0; --s) {
                    ...
                    if (k >= n[s].v.length - 1) {
                        k -= n[s].v.length;
                        n[s].v = S.substr(k + 1, n[s].v.length)
                    } else if (k < 0) n[s].v = "";
                    else {
                        n[s].v = S.substr(0, k + 1);
                        k = -1
                    }
                    n[s].t = "t";
                    _ = s
                ...
                for (s = C; s >= 0; --s) {
                    ...
                    y = n[s].v.substr(f + 1);
                    for (; f >= 0; --f) {
                        if (k >= 0 && (n[s].v.charAt(f) === "0" || n[s].v.charAt(f) === "#")) y = S.charAt(k--) + y
                    }
                    n[s].v = y;
                    n[s].t = "t";
                    _ = s
    ...
    function ze(e, r, t) {
        ...
        if (Y(a, 0)) return oe(r, t);
        if (r instanceof Date) r = hr(r, t.date1904);
        var n = Ue(a, r);
        if (Y(n[1])) return oe(r, t);
        if (r === true) r = "TRUE";
        else if (r === false) r = "FALSE";
        else if (r === "" || r == null) return "";
        return Re(n[1], r, t, n[0])
    }
    ...
    var qe = function Pc() {
        ...
        function m(e, r, t, a, n) {
            ...
            if (e === R) {
                ...
                if (!s) return;
                for (var o = 0; o < l; ++o) {
                    if ((i = ha(s, o * 4)) === R) break;
                    n.push(i)
                }
                if (r >= 1) m(ha(s, a - 4), r - 1, t, a, n)
            }
        }
        ...
        function w(e, r) {
            return new Date((ua(e, r + 4) / 1e7 * Math.pow(2, 32) + ua(e, r) / 1e7 - 11644473600) * 1e3)
        }
        ...
        function ye(e) {
            var r = xa(50 + Math.floor(e.length * 1.1));
            var t = ke(e, r);
            return r.slice(0, t)
        }
        ...
        function Ne(e, r) {
            ...
            for (f = 1; f < e.FullPaths.length; ++f) {
                ...
                k = k.slice(0, k.l);
                g[d] = typeof v.content == "string" ? Ze.bstr(v.content, 0) : Ze.buf(v.content, 0);
    ...
    function tr(e, r, t) {
        ...
        if (typeof Blob !== "undefined") {
            ...
            if (typeof URL !== "undefined" && typeof document !== "undefined" && document.createElement && URL.createObjectURL) {
                ...
                var l = "data:application/octet-stream;base64," + S(new Uint8Array(rr(a)));
                return chrome.downloads.download({
                    url: l,
                    filename: e,
                    saveAs: true
    ...
    var fr = Date.UTC(1899, 11, 31, 0, 0, 0);
    var ur = Date.UTC(1904, 0, 1, 0, 0, 0);
    ...
    function br(e, r) {
        ...
        var t = e.match(mr);
        if (t) return new Date((r ? ur : fr) + ((parseInt(t[1], 10) * 60 + parseInt(t[2], 10)) * 60 + (t[3] ? parseInt(t[3].slice(1), 10) : 0)) * 1e3 + (t[4] ? parseInt((t[4] + "000").slice(1, 4), 10) : 0));
        t = e.match(vr);
    ...
    function wr(e, r) {
        if (_ && Buffer.isBuffer(e)) {
            if (r && T) {
                if (e[0] == 255 && e[1] == 254) return kt(e.slice(2).toString("utf16le"));
                if (e[1] == 254 && e[2] == 255) return kt(d(e.slice(2).toString("binary")))
            }
            return e.toString("binary")
        }
        if (typeof TextDecoder !== "undefined") try {
            if (r) {
                if (e[0] == 255 && e[1] == 254) return kt(new TextDecoder("utf-16le").decode(e.slice(2)));
                if (e[0] == 254 && e[1] == 255) return kt(new TextDecoder("utf-16be").decode(e.slice(2)))
            }
            var t = {
                "â‚¬": "Â€",
                "â€š": "Â‚",
    ...
    var Cr = /^([01]?\d|2[0-3])(?:|:([0-5]?\d)(?:|(\.\d+)(?:|:([0-5]?\d))|:([0-5]?\d)(|\.\d+)))$/;
    ...
    var Fr = ["january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december"];

    function Dr(e) {
        if (_r.test(e)) return e.indexOf("Z") == -1 ? Nr(new Date(e)) : new Date(e);
        var r = e.toLowerCase();
        ...
        if (r.match(/jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec/)) {
            ...
            if (r.length > 3 && Fr.indexOf(r) == -1) return i
    ...
    function Ir(e) {
        ...
        if (e._data && e._data.getContent) return p(wr(Array.prototype.slice.call(e._data.getContent(), 0)));
        return null
    }
    ...
    function Rr(e) {
        return e && e.name.slice(-4) === ".bin" ? Pr(e) : Ir(e)
    }
    ...
    var nt = function () {
        ...
        function t(a) {
            ...
            if (i == -1) return n.replace(e, function (e, r) {
                return tt[e] || String.fromCharCode(parseInt(r, e.indexOf("x") > -1 ? 16 : 10)) || e
    ...
    function lt(e) {
        var r = e + "";
        return r.replace(it, function (e) {
            return at[e]
    ...
    var bt = "foo bar bazÃ¢Â˜ÂƒÃ°ÂŸÂÂ£";
    var wt = _ && (gt(bt) == mt(bt) && gt || vt(bt) == mt(bt) && vt) || mt;
    var kt = _ ? function (e) {
    ...
    function Et(e, r) {
        return "<" + e + (r.match(Tt) ? ' xml:space="preserve"' : "") + ">" + r + "</" + e + ">"
    }
    ...
    function Dt(e, r, t) {
        return "<" + e + (t != null ? Ft(t) : "") + (r != null ? (r.match(Tt) ? ' xml:space="preserve"' : "") + ">" + r + "</" + e : "/") + ">"
    }
    ...
    function Mt(e, r) {
        switch (typeof e) {
            case "string":
                var t = Dt("vt:lpwstr", lt(e));
                if (r) t = t.replace(/&quot;/g, "_x0022_");
                return t;
            case "number":
                return Dt((e | 0) == e ? "vt:i4" : "vt:r8", lt(String(e)));
            case "boolean":
                return Dt("vt:bool", e ? "true" : "false");
        }
        if (e instanceof Date) return Dt("vt:filetime", Ot(e));
    ...
    function Nt(e) {
        ...
        if (typeof Uint8Array !== "undefined" && e instanceof Uint8Array) return wt(M(I(e)));
    ...
    var Rt = ["http://schemas.openxmlformats.org/spreadsheetml/2006/main", "http://purl.oclc.org/ooxml/spreadsheetml/main", "http://schemas.microsoft.com/office/excel/2006/main", "http://schemas.microsoft.com/office/excel/2006/2"];
    var Lt = {
    ...
    var jt = _ ? function (e, r, t) {
        if (!Buffer.isBuffer(e) || !T) return Wt(e, r, t);
    ...
    var Gt = _ ? function Rc(e, r, t) {
        return Buffer.isBuffer(e) ? e.toString("utf8", r, t) : Xt(e, r, t)
    } : Xt;
    var Yt = function (e, r) {
        var t = ua(e, r);
    ...
    var Qt = qt;
    var ea = function Lc(e, r) {
        var t = ua(e, r);
        return t > 0 ? jt(e, r + 4, r + 4 + t) : ""
    };
    var ra = ea;
    var ta = function (e, r) {
        var t = ua(e, r);
    ...
    if (_) {
        ...
        ra = function Wc(e, r) {
            if (!Buffer.isBuffer(e) || !T) return ea(e, r);
            var t = e.readUInt32LE(r);
            return e.toString("utf16le", r + 4, r + 4 + t)
        };
        aa = function jc(e, r) {
            if (!Buffer.isBuffer(e)) return ta(e, r);
            var t = e.readUInt32LE(r);
    ...
    function pa(e, t) {
        ...
        switch (t) {
            ...
            case "cstr":
                e = 0;
                n = "";
                while ((o = oa(this, this.l + e++)) !== 0) l.push(m(o));
                n = l.join("");
                break;
            case "_wstr":
                e = 0;
                n = "";
                while ((o = ca(this, this.l + e)) !== 0) {
                    l.push(m(o));
                    e += 2
                }
                e += 2;
            ...
            case "dbcs-cont":
                ...
                for (f = 0; f < e; ++f) {
                    if (this.lens && this.lens.indexOf(u) !== -1) {
                        o = oa(this, u);
                        this.l = u + 1;
                        c = pa.call(this, e - f, o ? "dbcs-cont" : "sbcs-cont");
                        return l.join("") + c
                    }
                    l.push(m(ca(this, u)));
                    u += 2
            ...
            default:
                switch (e) {
                    ...
                    case -8:
                        if (t === "f") {
                            if (e == 8) s = ia(this, this.l);
                            else s = ia([this[this.l + 7], this[this.l + 6], this[this.l + 5], this[this.l + 4], this[this.l + 3], this[this.l + 2], this[this.l + 1], this[this.l + 0]], 0);
                            this.l += 8;
                            return s
                        } else e = 8;
                    case 16:
    ...
    function ba(e, n, i) {
        var s = 0,
            l = 0;
        if (i === "dbcs") {
            for (l = 0; l != n.length; ++l) ga(this, n.charCodeAt(l), this.l + 2 * l);
            s = 2 * n.length
    ...
    function wa(e, r) {
        var t = Vt(this, this.l, e.length >> 1);
    ...
    function Ea(e, r) {
        ...
        var t = za(e);
        if (!e.cRel && e.cRel != null) t = Ra(t);
        if (!e.rRel && e.rRel != null) t = Ma(t);
        return t
    }
    ...
    function Fa(e, r) {
        if (e.s.r == 0 && !e.s.rRel) {
            if (e.e.r == (r.biff >= 12 ? 1048575 : r.biff >= 8 ? 65536 : 16384) && !e.e.rRel) {
                return (e.s.cRel ? "" : "$") + Pa(e.s.c) + ":" + (e.e.cRel ? "" : "$") + Pa(e.e.c)
            }
        }
        if (e.s.c == 0 && !e.s.cRel) {
            if (e.e.c == (r.biff >= 12 ? 16383 : 255) && !e.e.cRel) {
                return (e.s.rRel ? "" : "$") + Oa(e.s.r) + ":" + (e.e.rRel ? "" : "$") + Oa(e.e.r)
            }
        }
    ...
    function ja(e) {
        var r = $a(e);
        return "$" + Pa(r.s.c) + "$" + Oa(r.s.r) + ":$" + Pa(r.e.c) + "$" + Oa(r.e.r)
    }
    ...
    function Xa(e, r) {
        ...
        if (e.z != null) try {
            return e.w = ze(e.z, t ? hr(r) : r)
        } catch (a) {}
        try {
            return e.w = ze((e.XF || {}).numFmtId || (t ? 14 : 0), t ? hr(r) : r)
        } catch (a) {
            return "" + r
        }
    }
    ...
    function Ga(e, r, t) {
        ...
        if (e.t == "e") return bn[e.v] || e.v;
        if (r == undefined) return Xa(e, e.v);
        return Xa(e, r)
    }
    ...
    function Ja(e, r, t) {
        ...
        if (i && a.origin != null) {
            if (typeof a.origin == "number") s = a.origin;
                ...
                var o = typeof a.origin == "string" ? Ua(a.origin) : a.origin;
                s = o.r;
                l = o.c
            }
    ...
    var pn = [null, "solid", "mediumGray", "darkGray", "lightGray", "darkHorizontal", "darkVertical", "darkDown", "darkUp", "darkGrid", "darkTrellis", "lightHorizontal", "lightVertical", "lightDown", "lightUp", "lightGrid", "lightTrellis", "gray125", "gray0625"];
    ...
    var kn = ["_xlnm.Consolidate_Area", "_xlnm.Auto_Open", "_xlnm.Auto_Close", "_xlnm.Extract", "_xlnm.Database", "_xlnm.Criteria", "_xlnm.Print_Area", "_xlnm.Print_Titles", "_xlnm.Recorder", "_xlnm.Data_Form", "_xlnm.Auto_Activate", "_xlnm.Auto_Deactivate", "_xlnm.Sheet_Title", "_xlnm._FilterDatabase"];
    var yn = {
        ...
        (e.match(Zr) || []).forEach(function (e) {
            ...
            switch (a[0].replace(qr, "<")) {
                ...
                case "<Default":
                    ...
                    break;
                case "<Override":
                    if (r[yn[a.ContentType]] !== undefined) r[yn[a.ContentType]].push(a.PartName);
                    break;
            }
        });
        if (r.xmlns !== Pt.CT) throw new Error("Unknown Namespace: " + r.xmlns);
    ...
    function _n(e, r, t) {
        ...
        var s = function (t) {
            if (e[t] && e[t].length > 0) {
                i = e[t][0];
                n[n.length] = Dt("Override", null, {
                    PartName: (i[0] == "/" ? "" : "/") + i,
                    ContentType: xn[t][r.bookType] || xn[t]["xlsx"]
                })
            }
        };
        var l = function (t) {
    ...
    function En(e, r) {
        ...
        (e.match(Zr) || []).forEach(function (e) {
            ...
            if (n[0] === "<Relationship") {
                var i = {};
                i.Type = n.Type;
                i.Target = nt(n.Target);
                i.Id = n.Id;
                if (n.TargetMode) i.TargetMode = n.TargetMode;
                var s = n.TargetMode === "External" ? n.Target : Xr(n.Target, r);
                t[s] = i;
                a[n.Id] = i
            }
        });
    ...
    function Fn(e) {
        var r = [Gr, Dt("Relationships", null, {
            xmlns: Pt.RELS
        })];
        nr(e["!id"]).forEach(function (t) {
            r[r.length] = Dt("Relationship", null, e["!id"][t])
        });
        if (r.length > 2) {
    ...
    function Dn(e, r, t, a, n, i) {
        ...
        n.Target = t;
        if (i) n.TargetMode = i;
        else if ([An.HLINK, An.XPATH, An.XMISS].indexOf(n.Type) > -1) n.TargetMode = "External";
        if (e["!id"][n.Id]) throw new Error("Cannot rewrite rId " + r);
        e["!id"][n.Id] = n;
        e[("/" + n.Target).replace("//", "/")] = n;
        return r
    }
    var On = "application/vnd.oasis.opendocument.spreadsheet";

    function Mn(e, r) {
        var t = Nt(e);
        var a;
        var n;
        while (a = It.exec(t)) switch (a[3]) {
            case "manifest":
                break;
            case "file-entry":
                n = et(a[0], false);
                if (n.path == "/" && n.type !== On) throw new Error("This OpenDocument is not a spreadsheet");
                break;
    ...
    function Rn(e) {
        ...
        for (var t = 0; t != e.length; ++t) {
            r.push(In(e[t][0], e[t][1]));
            r.push(Pn("", e[t][0]))
        }
        r.push(In("", "Document", "pkg"));
        r.push("</rdf:RDF>");
        return r.join("")
    }
    ...
    var Un = function () {
        var e = new Array(Bn.length);
        for (var r = 0; r < Bn.length; ++r) {
            var t = Bn[r];
    ...
    function zn(e) {
        ...
        for (var t = 0; t < Bn.length; ++t) {
            var a = Bn[t],
                n = e.match(Un[t]);
            if (n != null && n.length > 0) r[a[1]] = nt(n[1]);
    ...
    function $n(e, r, t, a, n) {
        ...
        n[e] = r;
        r = lt(r);
        a[a.length] = t ? Dt(e, r, t) : Et(e, r)
    }

    function Wn(e, r) {
        var t = r || {};
        var a = [Gr, Dt("cp:coreProperties", null, {
        ...
        if (e) {
            if (e.CreatedDate != null) $n("dcterms:created", typeof e.CreatedDate === "string" ? e.CreatedDate : Ot(e.CreatedDate, t.WTF), {
                "xsi:type": "dcterms:W3CDTF"
            }, a, n);
            if (e.ModifiedDate != null) $n("dcterms:modified", typeof e.ModifiedDate === "string" ? e.ModifiedDate : Ot(e.ModifiedDate, t.WTF), {
                "xsi:type": "dcterms:W3CDTF"
            }, a, n)
        }
    ...
    var Hn = ["Worksheets", "SheetNames", "NamedRanges", "DefinedNames", "Chartsheets", "ChartNames"];
    ...
    function Xn(e, r, t) {
        ...
        if (a.HeadingPairs && a.TitlesOfParts) Vn(a.HeadingPairs, a.TitlesOfParts, r, t);
        return r
    }
    ...
    function Kn(e) {
        ...
        nr(e).forEach(function a(n) {
            ++t;
            r[r.length] = Dt("property", Mt(e[n], true), {
    ...
    var Zn = [2, 3, 48, 49, 131, 139, 140, 245];
    var qn = function () {
        var e = {
            1: 437,
            2: 850,
    ...
    var Qn = function () {
        ...
        function s(e, r) {
            switch (r.type) {
                ...
                case "binary":
                    return l(e, r);
                case "buffer":
                    return l(_ && Buffer.isBuffer(e) ? e.toString("binary") : M(e), r);
                case "array":
                    return l(wr(e), r);
            }
            throw new Error("Unrecognized type " + r.type)
        ...
        function l(e, i) {
            ...
            for (; f !== s.length; ++f) {
                w = 0;
                var x = s[f].trim().replace(/\x1B([\x20-\x2F])([\x30-\x3F])/g, n).replace(r, t);
                    ...
                    case "NN": {
                        ...
                        for (u = 1; u < S.length; ++u) switch (S[u].charAt(0)) {
                            case "N":
                                ...
                                break;
                            case "E":
                                T.Ref = (i && i.sheet || "Sheet1") + "!" + Fs(S[u].slice(1));
                                break;
                        }
                    ...
                    for (u = 1; u < S.length; ++u) switch (S[u].charAt(0)) {
                        ...
                        case "K":
                            ...
                            if (_.charAt(0) === '"') {
                                ...
                                _ = xr(_);
                                P = "n";
                                if (p !== null && Pe(p) && i.cellDates) {
                                    _ = dr(y.Workbook.WBProps.date1904 ? _ + 1462 : _);
                        ...
                        case "C":
                            ...
                            break;
                        default:
                            if (i && i.WTF) throw new Error("SYLK bad record " + x);
                    }
                    if (E) {
                        if (!h[l][c]) h[l][c] = {
                            t: P,
                        ...
                        if (p) h[l][c].z = p;
                        if (i.cellText !== false && p) h[l][c].w = ze(h[l][c].z, h[l][c].v, {
        ...
        function f(e, r, t, a, n, i) {
            var s = "C;Y" + (t + 1) + ";X" + (a + 1) + ";K";
            switch (e.t) {
                case "n":
                    s += e.v || 0;
                    if (e.f && !e.F) s += ";E" + Os(e.f, {
                        r: t,
                        c: a
                    });
                    break;
        ...
        function h(e, r) {
            r.forEach(function (r, t) {
                ...
                if (r.hidden) a += "0";
                    ...
                    if (typeof r.width == "number" && !r.wpx) r.wpx = Ai(r.width);
                    if (typeof r.wpx == "number" && !r.wch) r.wch = Ti(r.wpx);
        ...
        function p(e, r, t) {
            ...
            for (m = i.s.r; m <= i.e.r; ++m) {
                ...
                for (v = i.s.c; v <= i.e.c; ++v) {
                    ...
                    g.push(f(s, e, m, v, r, c))
                }
                n.push(g.join(o))
            }
            a.push("F;P0;DG0G8;M255");
            if (e["!cols"]) h(a, e["!cols"]);
            if (e["!rows"]) d(a, e["!rows"]);
            ...
            for (; i !== t.length; ++i) {
                ...
                switch (+o) {
                    ...
                    case 0:
                        ...
                        else if (!isNaN(xr(c))) s[a][n] = xr(c);
                        else if (!isNaN(Dr(c).getDate())) {
                            s[a][n] = br(c);
                            if (!(r && r.UTC)) {
                                s[a][n] = Mr(s[a][n])
                            }
                ...
                for (var f = t.s.c; f <= t.e.c; ++f) {
                    ...
                    switch (u.t) {
                        ...
                        case "s":
                            ...
                            break;
                        case "d":
                            if (!u.w) u.w = ze(u.z || q[14], hr(br(u.v)));
                            if (r) c += n(u.w, "V");
                            else c += i(u.w);
                            break;
                        default:
    ...
    var ti = function () {
        function e(e, r, t, a, n) {
            ...
            else if (!isNaN(xr(e))) r[t][a] = xr(e);
            else if (!isNaN(Dr(e).getDate())) r[t][a] = br(e);
            else r[t][a] = e
        }
        ...
        function s(e, r) {
            ...
            var f = 0,
                ...
                p = 0,
                m = e.charCodeAt(0);
            var v = t.dateNF != null ? Ge(t.dateNF) : null;
            ...
            function g() {
                ...
                if (r.length === 0) a.t = "z";
                    ...
                    a.t = "b";
                    a.v = false
                } else if (!isNaN(c = xr(r))) {
                    a.t = "n";
                    a.v = c
                } else if (!isNaN((c = Dr(r)).getDate()) || v && r.match(v)) {
                    a.z = t.dateNF || q[14];
                    if (v && r.match(v)) {
                        var i = Ye(r, t.dateNF, r.match(v) || []);
                        c = br(i);
                        if (t && t.UTC === false) c = Mr(c)
                    } else if (t && t.UTC === false) c = Mr(c);
                    else if (t.cellText !== false && t.dateNF) a.w = ze(a.z, c);
                    if (t.cellDates) {
                        a.t = "d";
                        a.v = c
                    } else {
        ...
        function o(e, r) {
            var t = "",
                n = r.type == "string" ? [0, 0, 0, 0] : Bo(e, r);
            switch (r.type) {
                case "base64":
                    t = C(e);
                    break;
            ...
            if (n[0] == 239 && n[1] == 187 && n[2] == 191) t = wt(t.slice(3));
            else if (r.type != "string" && r.type != "buffer" && r.codepage == 65001) t = wt(t);
            else if (r.type == "binary" && typeof a !== "undefined" && r.codepage) t = a.utils.decode(r.codepage, a.utils.encode(28591, t));
            if (t.slice(0, 19) == "socialcalc:version:") return ri.to_sheet(r.type == "string" ? t : wt(t), r);
            return l(t, r)
        }
    ...
    function ai(e, r) {
        ...
        t.WTF = true;
        try {
            var n = Qn.to_workbook(e, t);
            t.WTF = a;
            return n
        } catch (i) {
            t.WTF = a;
            if (!i.message.match(/SYLK bad record ID/) && a) throw i;
            return ti.to_workbook(e, r)
        }
    }
    ...
    function fi(e, r) {
        ...
        if (e.match(/^\s*<(?:\w+:)?t[^>]*>/)) {
            a.t = nt(wt(e.slice(e.indexOf(">") + 1).split(/<\/(?:\w+:)?t>/)[0] || ""), true);
            a.r = wt(e);
            if (t) a.h = ft(a.t)
        } else if (e.match(oi)) {
            a.r = wt(e);
            a.t = nt(wt((e.replace(ci, "").match(li) || []).join("").replace(Zr, "")), true);
            if (t) a.h = si(ii(a.r))
        }
        return a
    }
    var ui = /<(?:\w+:)?sst([^>]*)>([\s\S]*)<\/(?:\w+:)?sst>/;
    var hi = /<(?:\w+:)?(?:si|sstItem)>/g;
    var di = /<\/(?:\w+:)?(?:si|sstItem)>/;
    ...
    function vi(e, r) {
        ...
        for (var a = 0; a != e.length; ++a) {
            ...
            if (n.r) i += n.r;
                ...
                if (n.t.match(mi)) i += ' xml:space="preserve"';
                i += ">" + lt(n.t) + "</t>"
            }
            i += "</si>";
            t[t.length] = i
    ...
    function Ai(e) {
        return Math.floor((e + Math.round(128 / _i) / 256) * _i)
    }

    function Ti(e) {
        return Math.floor((e - 5) / _i * 100 + .5) / 100
    }

    function Ei(e) {
        return Math.round((e * _i + 5) / _i * 256) / 256
    }
    ...
    function Di(e) {
        var r = Math.abs(e - Fi(e)),
            t = _i;
        if (r > .005)
            for (_i = Ci; _i < Si; ++_i)
                if (Math.abs(e - Fi(e)) <= r) {
                    r = Math.abs(e - Fi(e));
                    t = _i
                } _i = t
    }
        ...
        (e[0].match(Zr) || []).forEach(function (e) {
            ...
            switch (rt(l[0])) {
                ...
                case "</name>":
                    break;
                case "<b":
                    n.bold = l.val ? pt(l.val) : 1;
                    break;
                case "<b/>":
                    n.bold = 1;
                    break;
                case "<i":
                    n.italic = l.val ? pt(l.val) : 1;
                    break;
                case "<i/>":
                    n.italic = 1;
                    break;
                ...
                case "<u/>":
                    ...
                    break;
                case "<strike":
                    n.strike = l.val ? pt(l.val) : 1;
                    break;
                case "<strike/>":
                    n.strike = 1;
                    break;
                case "<outline":
                    n.outline = l.val ? pt(l.val) : 1;
                    break;
                case "<outline/>":
                    n.outline = 1;
                    break;
                case "<shadow":
                    n.shadow = l.val ? pt(l.val) : 1;
                    break;
                case "<shadow/>":
                    n.shadow = 1;
                    break;
                case "<condense":
                    n.condense = l.val ? pt(l.val) : 1;
                    break;
                case "<condense/>":
                    n.condense = 1;
                    break;
                case "<extend":
                    n.extend = l.val ? pt(l.val) : 1;
                    break;
                case "<extend/>":
                    n.extend = 1;
                    break;
                ...
                case "<color":
                    if (!n.color) n.color = {};
                    if (l.auto) n.color.auto = pt(l.auto);
                    if (l.rgb) n.color.rgb = l.rgb.slice(-6);
                    else if (l.indexed) {
                        n.color.index = parseInt(l.indexed, 10);
                        var o = gn[n.color.index];
                        if (n.color.index == 81) o = gn[1];
                        if (!o) o = gn[1];
                        ...
                        if (l.theme && t.themeElements && t.themeElements.clrScheme) {
                            n.color.rgb = yi(t.themeElements.clrScheme[n.color.theme].rgb, n.color.tint || 0)
                        }
                    }
                    break;
                case "<color/>":
    ...
    function $i(e) {
        ...
        [
            ...
            for (var a = t[0]; a <= t[1]; ++a)
                if (e[a] != null) r[r.length] = Dt("numFmt", null, {
                    numFmtId: a,
                    formatCode: lt(e[a])
                })
        });
    ...
    var Wi = ["numFmtId", "fillId", "fontId", "borderId", "xfId"];
    var ji = ["applyAlignment", "applyBorder", "applyFill", "applyFont", "applyNumberFormat", "applyProtection", "pivotButton", "quotePrefix"];
            ...
            switch (rt(i[0])) {
                ...
                case "<xf/>":
                    ...
                    for (s = 0; s < Wi.length; ++s)
                        if (a[Wi[s]]) a[Wi[s]] = parseInt(a[Wi[s]], 10);
                    for (s = 0; s < ji.length; ++s)
                        if (a[ji[s]]) a[ji[s]] = pt(a[ji[s]]);
                ...
                case "<alignment/>":
                    ...
                    if (i.wrapText) l.wrapText = pt(i.wrapText);
                    a.alignment = l;
                    break;
                case "</alignment>":
                    break;
    ...
    function Vi(e) {
        var r = [];
        r[r.length] = Dt("cellXfs", null);
        e.forEach(function (e) {
            r[r.length] = Dt("xf", null, e)
        });
        r[r.length] = "</cellXfs>";
    ...
    var Xi = function Gc() {
        ...
        return function i(s, l, o) {
            ...
            var f;
            if (f = s.match(e)) zi(f, c, o);
            if (f = s.match(a)) Ui(f, c, l, o);
            if (f = s.match(t)) Bi(f, c, l, o);
            if (f = s.match(n)) Li(f, c, l, o);
            if (f = s.match(r)) Hi(f, c, o);
            return c
        }
    }();

    function Gi(e, r) {
        var t = [Gr, Dt("styleSheet", null, {
                xmlns: Rt[0],
                "xmlns:vt": Pt.vt
            })],
            a;
        if (e.SSF && (a = $i(e.SSF)) != null) t[t.length] = a;
        ...
        if (a = Vi(r.cellXfs)) t[t.length] = a;
    ...
    var Yi = ["</a:lt1>", "</a:dk1>", "</a:lt2>", "</a:dk2>", "</a:accent1>", "</a:accent2>", "</a:accent3>", "</a:accent4>", "</a:accent5>", "</a:accent6>", "</a:hlink>", "</a:folHlink>"];
    ...
    function Ji(e, r, t) {
        ...
        (e[0].match(Zr) || []).forEach(function (e) {
            ...
            switch (n[0]) {
                ...
                case "</a:folHlink>":
                    if (n[0].charAt(1) === "/") {
                        r.themeElements.clrScheme[Yi.indexOf(n[0])] = a;
                        a = {}
                    } else {
    ...
    function Zi() {}
    var qi = /<a:clrScheme([^>]*)>[\s\S]*<\/a:clrScheme>/;
    var Qi = /<a:fontScheme([^>]*)>[\s\S]*<\/a:fontScheme>/;
    var es = /<a:fmtScheme([^>]*)>[\s\S]*<\/a:fmtScheme>/;
    ...
    var ts = /<a:themeElements([^>]*)>[\s\S]*<\/a:themeElements>/;

    function as(e, r) {
        if (!e || e.length === 0) e = ns();
        var t;
        var a = {};
        if (!(t = e.match(ts))) throw new Error("themeElements not found in theme");
        rs(t[0], a, r);
        a.raw = e;
        return a
    }
    ...
    var fs = /<(?:\w+:)?shape(?:[^\w][^>]*)?>([\s\S]*?)<\/(?:\w+:)?shape>/g;

    function us(e, r, t) {
        var a = 0;
        (e.match(fs) || []).forEach(function (e) {
            var n = "";
            var i = true;
            var s = -1;
            var l = -1,
                o = -1;
            e.replace(Zr, function (r, t) {
                var a = et(r);
                switch (rt(a[0])) {
                    case "<ClientData":
    ...
    function hs(e, r, t) {
        ...
        var i = [Dt("xml", null, {
            ...
            "xmlns:x": Lt.x,
            "xmlns:mv": Lt.mv
        }).replace(/\/>/, ">"), Dt("o:shapelayout", Dt("o:idmap", null, {
            "v:ext": "edit",
            data: e
        }), {
            "v:ext": "edit"
        ...
        var s = 65536 * e;
        var l = r || [];
        if (l.length > 0) i.push(Dt("v:shapetype", [Dt("v:stroke", null, {
            joinstyle: "miter"
        }), Dt("v:path", null, {
            gradientshapeok: "t",
            "o:connecttype": "rect"
    ...
    function ds(e, r, t) {
        ...
        var i = n.type == "gradient" ? Dt("o:fill", null, {
        ...
        return ["<v:shape" + Ft({
            ...
            fillcolor: "#ECFAD4",
            strokecolor: "#edeaa1"
        }) + ">", s, Dt("v:shadow", null, l), Dt("v:path", null, {
            "o:connecttype": "none"
        }), '<v:textbox><div style="text-align:left"></div></v:textbox>', '<x:ClientData ObjectType="Note">', "<x:MoveWithCells/>", "<x:SizeWithCells/>", Et("x:Anchor", [a.c + 1, 0, a.r + 1, 0, a.c + 3, 20, a.r + 5, 20].join(",")), Et("x:AutoFill", "False"), Et("x:Row", String(a.r)), Et("x:Column", String(a.c)), e[1].hidden ? "" : "<x:Visible/>", "</x:ClientData>", "</v:shape>"].join("")
    }
    ...
    function ps(e, r, t, a) {
        ...
        r.forEach(function (r) {
            ...
            if (!i) {
                ...
                var l = Va(e["!ref"] || "BDWGO1000001:A1");
    ...
    function bs(e, r, t) {
        var a = [Gr, Dt("ThreadedComments", null, {
            xmlns: Pt.TCMNT
        }).replace(/[\/]>/, ">")];
        e.forEach(function (e) {
            var n = "";
            (e[1] || []).forEach(function (i, s) {
                ...
                a.push(Dt("threadedComment", Et("text", i.t || ""), l))
            })
        });
    ...
    function ks(e) {
        var r = [Gr, Dt("personList", null, {
            xmlns: Pt.TCMNT,
            "xmlns:x": Rt[0]
        }).replace(/[\/]>/, ">")];
        e.forEach(function (e, t) {
            r.push(Dt("person", null, {
                displayName: e,
    ...
    var ys = "application/vnd.ms-office.vbaProject";
    ...
    var Os = function () {
        return function e(r, t) {
            return r.replace(Ds, function (e, r, a, n, i, s) {
                var l = Ia(n) - (a ? 0 : t.c);
                var o = Da(s) - (i ? 0 : t.r);
                var c = i == "$" ? o + 1 : o == 0 ? "" : "[" + o + "]";
                var f = a == "$" ? l + 1 : l == 0 ? "" : "[" + l + "]";
    ...
    function Ms(e, r) {
        return e.replace(Ds, function (e, t, a, n, i, s) {
            return t + (a == "$" ? a + n : Pa(Ia(n) + r.c)) + (i == "$" ? i + s : Oa(Da(s) + r.r))
        })
    }
    ...
    function Ls(e) {
        var r = "of:=" + e.replace(Ds, "$1[.$2$3$4$5]").replace(/\]:\[/g, ":");
    ...
    var zs = {};
    var $s = {};
    var Ws = typeof Map !== "undefined";

    function js(e, r, t) {
        var a = 0,
            n = e.length;
        if (t) {
            if (Ws ? t.has(r) : Object.prototype.hasOwnProperty.call(t, r)) {
                var i = Ws ? t.get(r) : t[r];
                for (; a < i.length; ++a) {
                    if (e[i[a]].t === r) {
                        e.Count++;
                        return i[a]
    ...
    function Gs(e, r, t, a, n, i, s) {
        ...
        if ((!a || a.cellText !== false) && e.t !== "z") try {
            if (q[r] == null) Ke(Ve[r] || "General", r);
            if (e.t === "e") e.w = e.w || bn[e.v];
            else if (r === 0) {
                if (e.t === "n") {
            ...
            } else if (e.t === "d") e.w = ze(r, hr(e.v, !!s), $s);
            else e.w = ze(r, e.v, $s)
        } catch (l) {
            if (a.WTF) throw l
        }
        ...
        if (t != null) try {
            ...
            if (e.s.fgColor && e.s.fgColor.theme && !e.s.fgColor.rgb) {
                e.s.fgColor.rgb = yi(n.themeElements.clrScheme[e.s.fgColor.theme].rgb, e.s.fgColor.tint || 0);
                if (a.WTF) e.s.fgColor.raw_rgb = n.themeElements.clrScheme[e.s.fgColor.theme].rgb
            }
            if (e.s.bgColor && e.s.bgColor.theme) {
                e.s.bgColor.rgb = yi(n.themeElements.clrScheme[e.s.bgColor.theme].rgb, e.s.bgColor.tint || 0);
    ...
    function Js(e, r) {
        var t = Va(r);
        if (t.s.r <= t.e.r && t.s.c <= t.e.c && t.s.r >= 0 && t.s.c >= 0) e["!ref"] = Wa(t)
    }
    var Ks = /<(?:\w:)?mergeCell ref="[A-Z0-9:]+"\s*[\/]?>/g;
    var Zs = /<(?:\w+:)?sheetData[^>]*>([\s\S]*)<\/(?:\w+:)?sheetData>/;
    var qs = /<(?:\w:)?hyperlink [^>]*>/gm;
    var Qs = /"(\w*:\w*)"/;
    var el = /<(?:\w:)?col\b[^>]*[\/]?>/g;
    var rl = /<(?:\w:)?autoFilter[^>]*([\/]|>([\s\S]*)<\/(?:\w:)?autoFilter)>/g;
    var tl = /<(?:\w:)?pageMargins[^>]*\/>/g;
    var al = /<(?:\w:)?sheetPr\b(?:[^>a-z][^>]*)?\/>/;
    var nl = /<(?:\w:)?sheetPr[^>]*(?:[\/]|>([\s\S]*)<\/(?:\w:)?sheetPr)>/;
    var il = /<(?:\w:)?sheetViews[^>]*(?:[\/]|>([\s\S]*)<\/(?:\w:)?sheetViews)>/;
    ...
    function sl(e, r, t, a, n, i, s) {
        ...
        var h = c.match(al);
        if (h) ol(h[0], l, n, t);
        else if (h = c.match(nl)) cl(h[0], h[1] || "", l, n, t, s, i);
        var d = (c.match(/<(?:\w*:)?dimension/) || {
            index: -1
        }).index;
        if (d > 0) {
            var p = c.slice(d, d + 50).match(Qs);
            if (p && !(r && r.nodim)) Js(l, p[1])
        }
        var m = c.match(il);
        if (m && m[1]) xl(m[1], n);
        var v = [];
        ...
        var y = f.match(Ks);
        if (y)
            for (d = 0; d != y.length; ++d) k[d] = Va(y[d].slice(y[d].indexOf('"') + 1));
        var x = f.match(qs);
        if (x) pl(l, x, a);
        var S = f.match(tl);
        if (S) l["!margins"] = ml(et(S[0]));
        var C;
        if (C = f.match(/legacyDrawing r:id="(.*?)"/)) l["!legrel"] = C[1];
        if (r && r.nodim) o.s.c = o.s.r = 0;
        if (!l["!ref"] && o.e.c >= o.s.c && o.e.r >= o.s.r) l["!ref"] = Wa(o);
    ...
    function ll(e) {
        ...
        for (var t = 0; t != e.length; ++t) r += '<mergeCell ref="' + Wa(e[t]) + '"/>';
        return r + "</mergeCells>"
    }
    ...
    function ol(e, r, t, a) {
        ...
        if (n.codeName) t.Sheets[a].CodeName = nt(wt(n.codeName))
    }
    ...
    function fl(e, r, t, a, n) {
        ...
        if (e && e["!outline"]) {
            ...
            l = (l || "") + Dt("outlinePr", null, f)
        }
        if (!i && !l) return;
        n[n.length] = Dt("sheetPr", l, s)
    }
    ...
    function dl(e) {
        ...
        return Dt("sheetProtection", null, r)
    }

    function pl(e, r, t) {
        var a = e["!data"] != null;
        for (var n = 0; n != r.length; ++n) {
            var i = et(wt(r[n]), true);
            if (!i.ref) return;
            var s = ((t || {})["!id"] || [])[i.id];
            if (s) {
                i.Target = s.Target;
                if (i.location) i.Target += "#" + nt(i.location)
            } else {
                i.Target = "#" + nt(i.location);
                s = {
                    Target: i.Target,
                    TargetMode: "Internal"
                }
    ...
    function kl(e, r, t, a) {
        var n = typeof e.ref == "string" ? e.ref : Wa(e.ref);
    ...
    function Sl(e, r, t, a) {
        ...
        return Dt("sheetViews", Dt("sheetView", null, n), {})
    }
    ...
    function Cl(e, r, t, a, n, i, s) {
        ...
        var u = e.t == "z" || e.v == null ? "" : Et("v", lt(l)),
            h = {
                r: r
            };
        var d = Xs(a.cellXfs, e, a);
        if (d !== 0) h.s = d;
        switch (e.t) {
            case "n":
                break;
            ...
            default:
                ...
                if (a && a.bookSST) {
                    u = Et("v", "" + js(a.Strings, e.v, a.revStrings));
                    h.t = "s";
                    break
                } else h.t = "str";
                break;
        ...
        return function l(o, c, f, u, h, d, p) {
            ...
            for (var $ = o.split(r), W = 0, j = $.length; W != j; ++W) {
                ...
                for (m = 0; m != g.length; ++m) {
                    ...
                    if ((b = x.match(i)) != null && b[1] !== "") S.v = nt(b[1]);
                    if (f.cellFormula) {
                        if ((b = x.match(s)) != null) {
                            if (b[1] == "") {
                                if (b[0].indexOf('t="shared"') > -1) {
                                    E = et(b[0]);
                                    if (I[E.si]) S.f = Ns(I[E.si][1], I[E.si][2], C.r);
                                }
                            } else {
                                S.f = nt(wt(b[1]), true);
                                if (!f.xlfn) S.f = Ps(S.f);
                                if (b[0].indexOf('t="array"') > -1) {
                                    S.F = (x.match(n) || [])[1];
                                    if (S.F.indexOf(":") > -1) N.push([Va(S.F), S.F])
                    ...
                    switch (S.t) {
                        ...
                        case "str":
                            S.t = "s";
                            S.v = S.v != null ? nt(wt(S.v), true) : "";
                            if (f.cellHTML) S.h = ft(S.v);
                            break;
                        case "inlineStr":
                            b = x.match(a);
                            S.t = "s";
                    ...
                    if (f.nodim) {
                        K = Ua(C.r);
                        if (u.s.r > K.r) u.s.r = K.r;
                        if (u.e.r < K.r) u.e.r = K.r
                    }
                    if (P) {
                        K = Ua(C.r);
                        if (!c["!data"][K.r]) c["!data"][K.r] = [];
                        c["!data"][K.r][K.c] = S
                    } else c[C.r] = S
                }
            }
    ...
    function Al(e, r, t, a) {
        ...
        for (h = s.s.c; h <= s.e.c; ++h) f[h] = Pa(h);
        for (u = s.s.r; u <= s.e.r; ++u) {
            ...
            for (h = s.s.c; h <= s.e.c; ++h) {
                ...
                if ((l = Cl(w, o, e, r, t, a, b)) != null) i.push(l)
            }
            if (i.length > 0 || d && d[u]) {
                m = {
                    r: c
    ...
    function Tl(e, r, t, a) {
        ...
        var u = [];
        fl(o, t, e, r, n);
        n[n.length] = Dt("dimension", null, {
            ref: c
        });
        n[n.length] = Sl(o, r, e, t);
        if (r.sheetFormat) n[n.length] = Dt("sheetFormatPr", null, {
        ...
        if (o["!links"].length > 0) {
            ...
            o["!links"].forEach(function (e) {
                ...
                if (e[1].Target.charAt(0) != "#") {
                    p = Dn(a, -1, lt(e[1].Target).replace(/#.*$/, ""), An.HLINK);
                    d["r:id"] = "rId" + p
                }
                if ((h = e[1].Target.indexOf("#")) > -1) d.location = lt(e[1].Target.slice(h + 1));
                if (e[1].Tooltip) d.tooltip = lt(e[1].Tooltip);
                d.display = e[1].display;
                n[n.length] = Dt("hyperlink", null, d)
            });
            n[n.length] = "</hyperlinks>"
        }
        delete o["!links"];
        if (o["!margins"] != null) n[n.length] = vl(o["!margins"]);
        if (!r || r.ignoreEC || r.ignoreEC == void 0) n[n.length] = Et("ignoredErrors", Dt("ignoredError", null, {
            numberStoredAsText: 1,
            sqref: c
        }));
        if (u.length > 0) {
            p = Dn(a, -1, "../drawings/drawing" + (e + 1) + ".xml", An.DRAW);
            n[n.length] = Dt("drawing", null, {
                "r:id": "rId" + p
            });
            o["!drawing"] = u
        }
        if (o["!comments"].length > 0) {
            p = Dn(a, -1, "../drawings/vmlDrawing" + (e + 1) + ".vml", An.VML);
            n[n.length] = Dt("legacyDrawing", null, {
                "r:id": "rId" + p
            });
            o["!legacy"] = p
        }
    ...
    function El(e) {
        ...
        var n = nt((e.match(/<c:formatCode>([\s\S]*?)<\/c:formatCode>/) || ["", "General"])[1]);
    ...
    function Ll(e) {
        ...
        Pl(e.WBView, Ml);
        Pl(e.Sheets, Nl);
        $s.date1904 = pt(e.WBProps.date1904)
    }
    ...
    function Wl(e) {
        ...
        for (var t = 0; t < e.SheetNames.length; ++t) Ys(e.Sheets[e.SheetNames[t]], e.SheetNames[t], t);
        e.SheetNames.forEach(function (r, t) {
            ...
            var i = Ha(r) + "!" + ja(a["!autofilter"].ref);
            if (n) n.Ref = i;
    ...
    function Hl(e, r) {
        ...
        e.replace(Zr, function l(o, c) {
            ...
            switch (rt(f[0])) {
                ...
                case "<workbookPr/>":
                    ...
                    if (f.codeName) t.WBProps.CodeName = wt(f.codeName);
                    break;
                case "</workbookPr>":
                    break;
                ...
                case "<definedName": {
                    ...
                    if (pt(f.hidden || "0")) i.Hidden = true;
                    s = c + o.length
                }
                break;
            case "</definedName>": {
                i.Ref = nt(wt(e.slice(s, c)));
                t.Names.push(i)
            }
            break;
            case "<definedName/>":
        ...
        if (Rt.indexOf(t.xmlns) === -1) throw new Error("Unknown Namespace: " + t.xmlns);
        Ll(t);
        return t
    }
    ...
    function Vl(e) {
        ...
        r[r.length] = Dt("workbookPr", null, a);
        ...
        if (t) {
            ...
            if (e.Workbook && e.Workbook.Names) e.Workbook.Names.forEach(function (e) {
                ...
                if (!e.Ref) return;
                r[r.length] = Dt("definedName", lt(e.Ref), t)
            });
            r[r.length] = "</definedNames>"
        }
        if (r.length > 2) {
    ...
    function Kl(e, r, t, a, n, i, s, l) {
        if (r.slice(-4) === ".bin") return _s(e, a, t, n, i, s, l);
        return As(e, a, t, n, i, s, l)
    }
    ...
    function ro(e, r, t, a) {
        if (t.slice(-4) === ".bin") return os(e, r, t, a);
        return ls(e, r, t, a)
    }
    ...
    function ao(e, r) {
        ...
        for (l = 0; l < c.length; ++l) {
            ...
            for (o = 0; o < w.length; ++o) {
                ...
                else if (!isNaN(xr(y))) T = {
                    t: "n",
                    v: xr(y)
                };
                else if (!isNaN(Dr(y).getDate())) {
                    T = {
                        t: "d",
                        v: br(y)
                    };
    ...
    function no(e, r, t, a) {
        ...
        for (var o = r.s.c; o <= r.e.c; ++o) {
            ...
            var p = d && d.v != null && (d.h || ft(d.w || (Ga(d), d.w) || "")) || "";
            s = {};
            if (c > 1) s.rowspan = c;
            if (f > 1) s.colspan = f;
            if (a.editable) p = '<span contenteditable="true">' + p + "</span>";
                ...
                if (d.l && (d.l.Target || "#").charAt(0) != "#") p = '<a href="' + ft(d.l.Target) + '">' + p + "</a>"
            }
            s.id = (a.id || "sjs") + "-" + h;
            i.push(Dt("td", p, s))
        }
    ...
    function fo(e, r, t) {
        ...
        if (n.origin != null) {
            if (typeof n.origin == "number") s = n.origin;
                ...
                var o = typeof n.origin == "string" ? Ua(n.origin) : n.origin;
                s = o.r;
                l = o.c
            }
        }
        ...
        for (; m < a.length && v < c; ++m) {
            ...
            for (g = b = 0; g < x.length; ++g) {
                var S = x[g];
                if (n.display && po(S)) continue;
                var C = S.hasAttribute("data-v") ? S.getAttribute("data-v") : S.hasAttribute("v") ? S.getAttribute("v") : xt(S.innerHTML);
        ...
        e["!ref"] = Wa(f);
        if (v >= c) e["!fullref"] = Wa((f.e.r = a.length - m + v - 1 + s, f));
        return e
    }
    ...
    function go(e, r, t) {
        ...
        while (i = It.exec(n)) {
            switch (i[3] = i[3].replace(/_.*$/, "")) {
                ...
                case "text":
                    if (i[1] === "/") {
                        d = n.slice(u, It.lastIndex - i[0].length);
            ...
            case "seconds": {
                ...
                if (c["decimal-places"]) l += "." + yr("0", +c["decimal-places"])
            }
            break;
            case "year": {
                c = et(i[0], false);
            ...
            case "scientific-number":
                c = et(i[0], false);
                l += "0." + yr("0", +c["min-decimal-places"] || +c["decimal-places"] || 2) + yr("?", +c["decimal-places"] - +c["min-decimal-places"] || 0) + "E" + (pt(c["forced-exponent-sign"]) ? "+" : "") + yr("0", +c["min-exponent-digits"] || 2);
                break;
            case "fraction":
                c = et(i[0], false);
                if (!+c["min-integer-digits"]) l += "#";
                else l += yr("0", +c["min-integer-digits"]);
                l += " ";
                l += yr("?", +c["min-numerator-digits"] || 1);
                l += "/";
                if (+c["denominator-value"]) l += c["denominator-value"];
                else l += yr("?", +c["min-denominator-digits"] || 1);
                break;
            case "currency-symbol":
                if (i[1] === "/") {
                    l += '"' + n.slice(u, It.lastIndex - i[0].length).replace(/"/g, '""') + '"'
                } else if (i[0].charAt(i[0].length - 2) !== "/") {
                    u = It.lastIndex
                } else l += "$";
                break;
            ...
            case "map":
                c = et(i[0], false);
                if (nt(c["condition"]) == "value()>=0") l = a[c["apply-style-name"]] + ";" + l;
            ...
            case "number":
                ...
                c = et(i[0], false);
                o = "";
                o += yr("0", +c["min-integer-digits"] || 1);
                if (pt(c["grouping"])) o = ue(yr("#", Math.max(0, 4 - o.length)) + o);
                if (+c["min-decimal-places"] || +c["decimal-places"]) o += ".";
                if (+c["min-decimal-places"]) o += yr("0", +c["min-decimal-places"] || 1);
                if (+c["decimal-places"] - (+c["min-decimal-places"] || 0)) o += yr("0", +c["decimal-places"] - (+c["min-decimal-places"] || 0));
                l += o;
                break;
            case "embedded-text":
                if (i[1] === "/") {
                    if (f == 0) l += '"' + n.slice(u, It.lastIndex - i[0].length).replace(/"/g, '""') + '"';
                    else l = l.slice(0, f) + '"' + n.slice(u, It.lastIndex - i[0].length).replace(/"/g, '""') + '"' + l.slice(f)
                } else if (i[0].charAt(i[0].length - 2) !== "/") {
                    u = It.lastIndex;
                    f = - +et(i[0], false)["position"] || 0
                }
                break;
            }
        }
    ...
    function bo(e, r, t) {
        ...
        It.lastIndex = 0;
        n = n.replace(/<!--([\s\S]*?)-->/gm, "").replace(/<!DOCTYPE[^\[]*\[[^\]]*\]>/gm, "");
        while (v = It.exec(n)) switch (v[3] = v[3].replace(/_.*$/, "")) {
            case "table":
                ;
            case "å·¥ä½œè¡¨":
                if (v[1] === "/") {
                    if (F.e.c >= F.s.c && F.e.r >= F.s.r) m["!ref"] = Wa(F);
                    else m["!ref"] = "A1:A1";
            ...
            case "æ•°æ®":
                if (v[0].charAt(v[0].length - 2) === "/") {
                    ...
                    if (w["style-name"] && M[w["style-name"]]) g.z = M[w["style-name"]];
                    if (a.cellFormula) {
                        if (w.formula) w.formula = nt(w.formula);
                        ...
                        if (w.formula) g.f = Rs(w.formula);
                        else
                            for (K = 0; K < z.length; ++K)
                                if (T >= z[K][0].s.r && T <= z[K][0].e.r)
                                    if (E >= z[K][0].s.c && E <= z[K][0].e.c) g.F = z[K][1]
                    }
                    ...
                    switch (g.t) {
                        case "boolean":
                            g.t = "b";
                            g.v = pt(w["boolean-value"]) || +w["boolean-value"] >= 1;
                            break;
                        case "float":
                            g.t = "n";
                            g.v = parseFloat(w.value);
                            if (a.cellDates && g.z && Pe(g.z)) {
                                g.v = dr(g.v + ($.WBProps.date1904 ? 1462 : 0));
                        ...
                        case "date":
                            g.t = "d";
                            g.v = br(w["date-value"], $.WBProps.date1904);
                            if (!a.cellDates) {
                                g.t = "n";
                                g.v = hr(g.v, $.WBProps.date1904)
                            }
                            if (!g.z) g.z = "m/d/yy";
                            break;
                        case "time":
                            g.t = "n";
                            g.v = pr(w["time-value"]) / 86400;
                            if (a.cellDates) {
                                g.v = dr(g.v);
                                g.t = typeof g.v == "number" ? "n" : "d"
                            }
                        ...
                        if (!(a.sheetRows && a.sheetRows <= T)) {
                            for (var q = 0; q < B; ++q) {
                                ...
                                if (a.dense) {
                                    ...
                                    m["!data"][T + q][E] = q == 0 ? g : kr(g);
                                    while (--U > 0) m["!data"][T + q][E + U] = kr(g)
                                } else {
                                    m[za({
                                        r: T + q,
                                        c: E
            ...
            case "annotation":
                if (v[1] === "/") {
                    ...
                    i.push([v[3], false]);
                    var Q = et(v[0], true);
                    if (!(Q["display"] && pt(Q["display"]))) H.hidden = true;
                    S = k;
                    C = y;
                    A = _;
                    k = "";
            ...
            case "time-style":
                if (v[1] === "/") {
                    var ee = It.lastIndex;
                    go(n.slice(o, It.lastIndex), r, O);
                    It.lastIndex = ee
                } else if (v[0].charAt(v[0].length - 2) !== "/") {
                    o = It.lastIndex - v[0].length
                }
                break;
            case "script":
                break;
        ...
        case "database-range":
            if (v[1] === "/") break;
            try {
                j = Bs(et(v[0])["target-range-address"]);
                d[j[0]]["!autofilter"] = {
                    ref: j[1]
                }
            } catch (ne) {}
    ...
    function wo(e, r) {
        r = r || {};
        if (Lr(e, "META-INF/manifest.xml")) Mn(Ur(e, "META-INF/manifest.xml"), r);
        var t = zr(e, "styles.xml");
        var a = t && go(wt(t), r);
        var n = zr(e, "content.xml");
        if (!n) throw new Error("Missing content.xml in ODS / UOF file");
        var i = bo(wt(n), r, a);
        if (Lr(e, "meta.xml")) i.Props = zn(Ur(e, "meta.xml"));
        i.bookType = "ods";
        return i
    }
    ...
    var yo = function () {
        ...
        var r = "<office:document-styles " + Ft({
    ...
    function So(e, r, t) {
        ...
        return "      <table:named-expressions>\n" + a.map(function (e) {
            var r = (t == -1 ? "$" : "") + Us(e.Ref);
            return "        " + Dt("table:named-range", null, {
                "table:name": e.Name,
    ...
    var Co = function () {
        var e = function (e) {
            return lt(e).replace(/  +/g, function (e) {
        ...
        var t = function (t, a, n, i, s, l) {
            var o = [];
            o.push('      <table:table table:name="' + lt(a.SheetNames[n]) + '" table:style-name="ta1">\n');
            var c = 0,
                f = 0,
                u = $a(t["!ref"] || "A1");
            var h = t["!merges"] || [],
                ...
                for (; f <= u.e.c; ++f) {
                    ...
                    switch (y.t) {
                        ...
                        case "str":
                            ...
                            break;
                        case "d":
                            w = y.w || br(y.v, l).toISOString();
                            b["office:value-type"] = "date";
                            b["office:date-value"] = br(y.v, l).toISOString();
                    ...
                    if (y.l && y.l.Target) {
                        var C = y.l.Target;
                        C = C.charAt(0) == "#" ? "#" + Us(C.slice(1)) : C;
                        if (C.charAt(0) != "#" && !C.match(/^\w+:/)) C = "../" + C;
                        S = Dt("text:a", S, {
                            "xlink:href": C.replace(/&/g, "&amp;")
                        })
                    }
                    ...
                    if (y.c) {
                        ...
                        _ = Dt("office:annotation", T, E) + _
                    }
                    o.push("          " + Dt("table:table-cell", _, b) + "\n")
                }
                o.push("        </table:table-row>\n")
            }
            if ((a.Workbook || {}).Names) o.push(So(a.Workbook.Names, a.SheetNames, n));
            o.push("      </table:table>\n");
            return o.join("")
        };
        var a = function (e, r) {
        ...
        return function n(e, r) {
            ...
            if ((e.Workbook || {}).Names) n.push(So(e.Workbook.Names, e.SheetNames, -1));
            n.push("    </office:spreadsheet>\n");
            n.push("  </office:body>\n");
    ...
    function _o(e, r) {
        if (r.bookType == "fods") return Co(e, r);
        var t = Hr();
        var a = "";
        var n = [];
        var i = [];
        a = "mimetype";
        jr(t, a, "application/vnd.oasis.opendocument.spreadsheet");
        a = "content.xml";
        jr(t, a, Co(e, r));
        n.push([a, "text/xml"]);
    ...
    function Fo(e) {
        if (An.WS.indexOf(e) > -1) return "sheet";
        if (An.CS && e == An.CS) return "chart";
        if (An.DS && e == An.DS) return "dialog";
        if (An.MS && e == An.MS) return "macro";
    ...
    function Oo(e, r, t, a, n, i, s, l) {
        ...
        var o = Xr(e["!legdrawel"].Target, a);
        var c = zr(t, o, true);
        if (c) us(wt(c), e, l || [])
    }

    function Mo(e, r, t, a, n, i, s, l, o, c, f, u) {
        try {
            i[a] = En(zr(e, t, true), r);
            var h = Ur(e, r);
            var d;
            switch (l) {
                case "sheet":
                ...
                case "chart":
                    ...
                    if (!d || !d["!drawel"]) break;
                    var p = Xr(d["!drawel"].Target, r);
                    var m = Tn(p);
                    var v = cs(zr(e, p, true), En(zr(e, m, true), p));
                    var g = Xr(v, p);
                    var b = Tn(g);
                    d = Fl(zr(e, g, true), g, o, En(zr(e, b, true), g), c, d);
                    break;
                case "macro":
            ...
            if (i && i[a]) nr(i[a]).forEach(function (t) {
                var n = "";
                if (i[a][t].Type == An.CMNT) {
                    n = Xr(i[a][t].Target, r);
                    w = Ql(Ur(e, n, true), n, o);
                    if (!w || !w.length) return;
                    ps(d, w, false)
                }
                if (i[a][t].Type == An.TCMNT) {
                    n = Xr(i[a][t].Target, r);
                    k = k.concat(gs(Ur(e, n, true), o))
                }
            });
            if (k && k.length) ps(d, k, true, o.people || []);
            Oo(d, l, e, r, n, o, c, w)
        } catch (y) {
            if (o.WTF) throw y
        }
    ...
    function Io(e, r) {
        ...
        var n = Wr(e);
        var i = Cn(zr(e, "[Content_Types].xml"));
        var s = false;
        var l, o;
        if (i.workbooks.length === 0) {
            o = "xl/workbook.xml";
            if (Ur(e, o, true)) i.workbooks.push(o)
        }
        if (i.workbooks.length === 0) {
            o = "xl/workbook.bin";
            if (!Ur(e, o, true)) throw new Error("Could not find workbook");
            i.workbooks.push(o);
            s = true
        }
        ...
        if (!r.bookSheets && !r.bookProps) {
            zs = [];
            if (i.sst) try {
                zs = ql(Ur(e, No(i.sst)), i.sst, r)
            } catch (u) {
                if (r.WTF) throw u
            }
            if (r.cellStyles && i.themes.length) c = as(zr(e, i.themes[0].replace(/^\//, ""), true) || "", r);
            if (i.style) f = Zl(Ur(e, No(i.style)), i.style, c, r)
        }
        i.links.map(function (t) {
            try {
                var a = En(zr(e, Tn(No(t))), t);
                return ro(Ur(e, No(t)), a, t, r)
            } catch (n) {}
        });
        var h = Xl(Ur(e, No(i.workbooks[0])), i.workbooks[0], r);
        var d = {},
            p = "";
        if (i.coreprops.length) {
            p = Ur(e, No(i.coreprops[0]), true);
            if (p) d = zn(p);
            if (i.extprops.length !== 0) {
                p = Ur(e, No(i.extprops[0]), true);
                if (p) Xn(p, d, r)
            }
        }
        var m = {};
        ...
        l = {};
        var g = {};
        if (r.bookDeps && i.calcchain) g = eo(Ur(e, No(i.calcchain)), i.calcchain, r);
        var b = 0;
        var w = {};
        var k, y; {
            var x = h.Sheets;
        ...
        if (!Lr(e, A)) A = "xl/_rels/workbook." + C + ".rels";
        var T = En(zr(e, A, true), A.replace(/_rels.*/, "s5s"));
        if ((i.metadata || []).length >= 1) {
            r.xlmeta = to(Ur(e, No(i.metadata[0])), i.metadata[0], r)
        }
        if ((i.people || []).length >= 1) {
            r.people = ws(Ur(e, No(i.people[0])), r)
        }
        if (T) T = Do(T, h.Sheets);
        var E = Ur(e, "xl/worksheets/sheet.xml", true) ? 1 : 0;
        e: for (b = 0; b != d.Worksheets; ++b) {
            var F = "sheet";
            if (T && T[b]) {
                k = "xl/" + T[b][1].replace(/[\/]?xl\//, "");
                if (!Lr(e, k)) k = T[b][1];
                if (!Lr(e, k)) k = A.replace(/_rels\/.*$/, "") + T[b][1];
                F = T[b][2]
            } else {
            ...
            Mo(e, k, y, d.SheetNames[b], b, w, l, F, r, h, c, f)
        }
        v = {
            Directory: i,
            Workbook: h,
        ...
        if (r && r.bookVBA) {
            if (i.vba.length > 0) v.vbaraw = Ur(e, No(i.vba[0]), true);
            else if (i.defaults && i.defaults.bin === ys) v.vbaraw = Ur(e, "xl/vbaProject.bin", true)
        }
    ...
    function Ro(e, r) {
        ...
        jr(i, s, Gn(e.Props, r));
        n.extprops.push(s);
        Dn(r.rels, 3, s, An.EXT_PROPS);
        if (e.Custprops !== e.Props && nr(e.Custprops || {}).length > 0) {
            s = "docProps/custom.xml";
            jr(i, s, Kn(e.Custprops, r));
            n.custprops.push(s);
            Dn(r.rels, 4, s, An.CUST_PROPS)
        }
        var f = ["SheetJ5"];
        r.tcid = 0;
        for (l = 1; l <= e.SheetNames.length; ++l) {
            ...
            switch (d) {
                ...
                default:
                    ...
                    jr(i, s, write_ws_bin(l - 1, r, e, u));
                    n.sheets.push(s);
                    Dn(r.wbrels, -1, "worksheets/sheet" + l + "." + t, An.WS[0]);
            }
            if (h) {
                var p = h["!comments"];
                var m = false;
                ...
                if (p && p.length > 0) {
                    ...
                    if (g) {
                        ...
                        Dn(u, -1, "../threadedComments/threadedComment" + l + ".xml", An.TCMNT)
                    }
                    v = "xl/comments" + l + "." + t;
                    jr(i, v, write_comments_bin(p, r));
                    n.comments.push(v);
                    Dn(u, -1, "../comments" + l + "." + t, An.CMNT);
                    m = true
                }
                if (h["!legacy"]) {
                    if (m) jr(i, "xl/drawings/vmlDrawing" + l + ".vml", hs(l, h["!comments"]))
                }
                delete h["!comments"];
                delete h["!legacy"]
            }
            if (u["!id"].rId1) jr(i, Tn(s), Fn(u))
        }
        if (r.Strings != null && r.Strings.length > 0) {
            s = "xl/sharedStrings." + t;
            jr(i, s, write_sst_bin(r.Strings, r));
            n.strs.push(s);
            Dn(r.wbrels, -1, "sharedStrings." + t, An.SST)
        }
        s = "xl/workbook." + t;
        jr(i, s, write_wb_bin(e, r));
        n.workbooks.push(s);
        Dn(r.rels, 1, s, An.WB);
        ...
        jr(i, s, b);
        n.themes.push(s);
        Dn(r.wbrels, -1, "theme/theme1.xml", An.THEME);
        s = "xl/styles." + t;
        jr(i, s, write_sty_bin(e, r));
        n.styles.push(s);
        Dn(r.wbrels, -1, "styles." + t, An.STY);
        if (e.vbaraw && a) {
            s = "xl/vbaProject.bin";
            jr(i, s, e.vbaraw);
            n.vba.push(s);
            Dn(r.wbrels, -1, "vbaProject.bin", An.VBA)
        }
        s = "xl/metadata." + t;
        jr(i, s, write_xlmeta_bin());
        n.metadata.push(s);
        Dn(r.wbrels, -1, "metadata." + t, An.XLMETA);
        if (f.length > 1) {
            s = "xl/persons/person.xml";
            jr(i, s, ks(f, r));
            n.people.push(s);
            Dn(r.wbrels, -1, "persons/person.xml", An.PEOPLE)
        }
        jr(i, "[Content_Types].xml", _n(n, r));
        jr(i, "_rels/.rels", Fn(r.rels));
        jr(i, "xl/_rels/workbook." + t + ".rels", Fn(r.wbrels));
        delete r.revssf;
        delete r.ssf;
        return i
    }
    ...
    function Wo(e, r) {
        ...
        if (a[0] == 239 && a[1] == 187 && a[2] == 191) t = wt(t);
        r.type = "binary";
        return $o(t, r)
    }
    ...
    function Ho(e) {
        return !e.match(/[^\x00-\x7F]/) ? e : kt(e)
    }

    function Vo(e, r, t, a) {
        if (a) {
            t.type = "string";
            return ti.to_workbook(e, t)
        }
        return ti.to_workbook(r, t)
    }
    ...
    function Xo(e, r) {
        ...
        if (typeof ArrayBuffer !== "undefined" && e instanceof ArrayBuffer) return Xo(new Uint8Array(e), (t = kr(t), t.type = "array", t));
        ...
        switch ((i = Bo(n, t))[0]) {
            case 208:
                if (i[1] === 207 && i[2] === 17 && i[3] === 224 && i[4] === 161 && i[5] === 177 && i[6] === 26 && i[7] === 225) return Uo(qe.read(n, t), t);
                break;
            case 9:
            ...
            case 73:
                ...
                if (i[1] === 68) return ai(n, t);
                break;
            case 84:
                if (i[1] === 65 && i[2] === 66 && i[3] === 76) return ei.to_workbook(n, t);
                break;
            case 80:
        ...
        if (Zn.indexOf(i[0]) > -1 && i[2] <= 12 && i[3] <= 31) return qn.to_workbook(n, t);
        return Vo(e, n, t, s)
    }
    ...
    function tc(e, r) {
        switch (r.type) {
            ...
            case "binary":
                ...
                return r.type == "base64" ? y(t) : r.type == "string" ? wt(t) : t;
            case "file":
                return tr(r.file, e);
            case "buffer":
                return e;
    ...
    function nc(e, r) {
        ...
        switch (t.bookType || "xlsb") {
            ...
            case "slk":
                ;
            case "sylk":
                return ec(Qn.from_sheet(e.Sheets[e.SheetNames[n]], t, e), t);
            case "htm":
                ;
            case "html":
            ...
            case "dif":
                return ec(ei.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
            case "dbf":
                return tc(qn.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
            case "prn":
                return ec(ti.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
            case "rtf":
                return ec(sheet_to_rtf(e.Sheets[e.SheetNames[n]], t), t);
            case "eth":
                return ec(ri.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
            case "fods":
                return ec(_o(e, t), t);
            case "wk1":
    ...
    function oc(e, r, t, a) {
        ...
        return Qe.writeFile(e, nc(r, n), i)
    }
            ...
            for (var p = r.s.c; p <= r.e.c; ++p) {
                ...
                if (i[p] != null) {
                    if (v == null) {
                        ...
                        h[i[p]] = c && (m.t !== "n" || m.t === "n" && s.rawNumbers !== false) ? v : Ga(m, v, s)
                    }
                    if (v != null) f = false
                }
            }
    ...
    function hc(e, r, t, a, n, i, s, l) {
        ...
        for (var p = r.s.c; p <= r.e.c; ++p) {
            ...
            if (m == null) f = "";
                ...
                o = false;
                f = "" + (l.rawNumbers && m.t == "n" ? m.v : Ga(m, null, l));
                for (var v = 0, g = 0; v !== f.length; ++v)
                    if ((g = f.charCodeAt(v)) === n || g === i || g === 34 || l.forceQuotes) {
                        f = '"' + f.replace(uc, '""') + '"';
                        break
                    } if (f == "ID") f = '"ID"'
    ...
    function mc(e) {
        ...
        var o = [];
        var c = e["!data"] != null;
        for (l = n.s.c; l <= n.e.c; ++l) s[l] = Pa(l);
    ...
    function vc(e, r, t) {
        ...
        if (s && a.origin != null) {
            if (typeof a.origin == "number") l = a.origin;
                ...
                var c = typeof a.origin == "string" ? Ua(a.origin) : a.origin;
                l = c.r;
                o = c.c
            }
        }
            ...
            nr(e).forEach(function (t) {
                ...
                if (c && typeof c === "object" && !(c instanceof Date)) {
                    ...
                    if (typeof c == "number") f = "n";
                        ...
                        u = v != null && v.z && Pe(v.z) ? v.z : a.dateNF || q[14]
    ...
    function bc(e, r, t) {
        ...
        if (typeof r != "number") return bc(e, za(r));
        return bc(e, Pa(t || 0) + Oa(r))
    }
    ...
    function Tc(e, r, t, a) {
        var n = typeof r != "string" ? r : Va(r);
        var i = typeof r == "string" ? r : Wa(r);
    ...
    var Ec = {
        ...
        cell_set_number_format: Sc,
        cell_set_hyperlink: Cc,
